...
change template
https://github.com/sctyner/sctyner.github.io/blob/master/static/resume/tyner-cv-pd.Rmd
...
2. Coatsworth, J.D., **Wendt, K.E.**, Lunkenheimer, E.S., & Cleavinger, E.J. Effects of parental mindfulness induction on autonomic regulation and mood during challenging parent-child interactions. Manuscript in preparation.
3. **Wendt, K.E.**, Coatsworth, J.D., Lunkenheimer, E.S., & Cleavinger, E.J. Individual moderators of mindfulness induction on parental autonomic regulation and mood. Manuscript in preparation.
4. SPR Cup paper
...
1. Paper session moderation Do parents matter? Implications of parenting characteristics and practices on children's adjustment and risk behaviors
1. SPR Cup presentation
2. **Wendt, K.E.**, Coatsworth, J.D., Lunkenheimer, E.S., & Cleavinger, E.J. (2019, May). Effects of parental mindfulness meditation on respiratory sinus arrhythmia and mood during challenging parent-child interactions. Poster presented at Society for Prevention Research Annual Meeting, San Francisco, CA.
...
4. **Wendt, K.E.** & Coatsworth, J.D. (2018, April). Exploring moderators of mindfulness training on parental physiological regulation and mood. Paper presented at Celebrate Undergraduate Research and Creativity Showcase, Colorado State University, Fort Collins, CO.
5. **Wendt, K.E.**, Skoranski, A.M., & Lunkenheimer, E.S. (2017, April). Maternal depression moderates the relationship between mother-child coregulation and child emotion regulation. Poster presented at Celebrate Undergraduate Research and Creativity Showcase, Colorado State University, Fort Collins, CO.


# Grantsmanship & Funding

GSC lunches for Speaker Series

## Under review

Mind-Life PEACE Grant Letter of Intent (Submitted March 2019)
...
Departmental Travel Grant (SPR Cup) \hfill 2019
...
Graduate Student Council Team Travel Award (SPR Cup) \hfill 2019 [offered but not awarded due to institutional regulations]
...
1. Uncoast Unconf for R \hfill April 14-16, 2019
2. NIH Grant-Writing Workshop, Dr. Maria Esformes \hfill August 3, 2018
3. MindWare Heart Rate Variability Seminar, Dr. Gary Berntson \hfill June 9-10, 2018
4. Bayesian Causal Mediation Analysis Workshop, Dr. David MacKinnon et al. \hfill May 29, 2018
5. Mental Health-Education Integration Consortium (MHEDIC) \hfill May 3-4, 2018


# Computer Skills

Programming and statistical languages: Proficient in `R` (via `RStudio`;  `RMarkdown`) and SPSS
...
Rich Text Formats via LibreOffice and Microsoft Office (Word, Excel, PowerPoint) 
