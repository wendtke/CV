...
**Wendt, K.E.**, Zhang, S., Feldman, M.F., & Anderson, G.B. (2019). `psyphr`: R package suite to wrangle, filter, visualize, analyze, and share physiological data. In active development.

# Workshops

Grant, S.P., **Wendt, K.E.**, & Anderson, G.B. (2020, May).  Open science for prevention scientists: Efficient, transparent, and reproducible research workflows. Preconference workshop proposal under review for the Society for Prevention Research Annual Meeting, Washington, D.C.
