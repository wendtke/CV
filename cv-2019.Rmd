...
Project management, grant administration, participant recruitment and retention, technical and scientific writing, and data collection and analysis using dynamic systems-based methods and modeling for NIH-funded longitudinal study *investigating parents’ and young children’s (2.5 to 4 years old) dyadic coordination of emotions, goal-oriented behaviors, and physiology and related risk for child maltreatment*
