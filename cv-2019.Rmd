...
- RStudio Diversity Scholarship for `rstudio::conf(2020L)` \hfill 2020
- Departmental Travel Grant for `rstudio::conf(2020L)` \hfill 2020
...
- `rstudio::conf(2020L)` \hfill January 29-30, 2020
